...
Your `.rai_profile` should look something like this (indented with tabs!). The following profile is just a sample. Your actual profile may contain other fields like team and role.
